...
<select id="sel_citizenship_other35" name="other35" class="seleCss" style="width: 100px;">
	...
	<option value="南乔治亚岛和南桑德维奇岛">南乔治亚岛和南桑德维奇岛</option>
