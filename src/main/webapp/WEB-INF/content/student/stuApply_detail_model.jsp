...
<%--	<br />填表须知：请您及时将《学生报名表》《学籍表》《预防接种登记表》三表填完、提交(提交之后信息将无法修改)、再次提交。直到《学生报名表》状态为：审核中，其他两表状态为：已提交。请您在2019年6月15（桂子山校区）、19日（南湖校区）、20日（南湖校区）到指定校区进行现场审查。--%>
<%--</strong></div>--%>
<div class="clear"></div>
<div class="base_title">
	<em></em>
	<strong>$J{year}年钟家村寄宿学校新生学生报名表</strong>
